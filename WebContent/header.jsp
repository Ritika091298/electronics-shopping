...
<body style="background-color: #0977b3;">
	<!--Company Header Starting  -->
	<div class="container-fluid text-center"
		style="margin-top: 40px; background-color: #0977b3; color: Black; padding: 5px;">
		<h2>Shop Electronics</h2>
		<h6>Electronics at best prices</h6>
		<form class="Roboto" action="index.jsp" method="get">
		...
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.jsp"><span
					class="glyphicon glyphicon-home">&nbsp;</span>Electronics Hub</a>
			</div>
